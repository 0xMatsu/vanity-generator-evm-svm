...
fn build_cuda_libs() {
    ...
    cc::Build::new()
        ...
        .flag("-cudart=static")
        // Target a wider set of architectures (plus PTX fallback for 8.6)
    ...
    #[cfg(target_os = "windows")]
    {
        ...
        let cuda_path = std::env::var("CUDA_PATH")
            .unwrap_or_else(|_| "C:\\Program Files\\NVIDIA GPU Computing Toolkit\\CUDA\\v13.0".to_string());
        println!("cargo:rustc-link-search=native={}" , format!("{}\\lib\\x64", cuda_path));
