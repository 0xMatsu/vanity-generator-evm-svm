// secp256k1 256-bit arithmetic operations
// Exact copy from MrSpike63's implementation
// https://github.com/MrSpike63/vanity-eth-address (AGPL v3)
...
#define P _uint256{0xFFFFFC2F, 0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF}

__device__ __host__ bool gte_256(_uint256 x, _uint256 y) {
    bool gte = false;
    bool equal = true;
    gte |= (x.h > y.h); equal &= (x.h == y.h);
...
__device__ __host__ _uint256c uint256_to_uint256c(_uint256 x) {
    return _uint256c{false, x.a, x.b, x.c, x.d, x.e, x.f, x.g, x.h};
}
...
__device__ _uint256c add_256_with_c(_uint256 x, _uint256 y) {
    ...
    asm(
        ...
        "addc.cc.u32 %7, %16, %24;  \n\t"
        "addc.u32 %8, 0x0, 0x0;     \n\t"
        : "=r"(result.a), "=r"(result.b), "=r"(result.c), "=r"(result.d),
          "=r"(result.e), "=r"(result.f), "=r"(result.g), "=r"(result.h), "=r"(carry)
        : "r"(x.a), "r"(x.b), "r"(x.c), "r"(x.d), "r"(x.e), "r"(x.f), "r"(x.g), "r"(x.h),
          "r"(y.a), "r"(y.b), "r"(y.c), "r"(y.d), "r"(y.e), "r"(y.f), "r"(y.g), "r"(y.h)
    );
...
__device__ _uint256 sub_256(_uint256 x, _uint256 y) {
    ...
    asm(
        ...
        "subc.u32 %7, %15, %23;     \n\t"
        : "=r"(result.a), "=r"(result.b), "=r"(result.c), "=r"(result.d),
          "=r"(result.e), "=r"(result.f), "=r"(result.g), "=r"(result.h)
        : "r"(x.a), "r"(x.b), "r"(x.c), "r"(x.d), "r"(x.e), "r"(x.f), "r"(x.g), "r"(x.h),
          "r"(y.a), "r"(y.b), "r"(y.c), "r"(y.d), "r"(y.e), "r"(y.f), "r"(y.g), "r"(y.h)
    );
    return result;
...
// This is MrSpike63's exact 256-bit modular multiplication - DO NOT MODIFY
__device__ _uint256 mul_256_mod_p(_uint256 x, _uint256 y) {
    ...
    asm(
        ...
        "addc.u32 %8, 0x0, 0x0;             \n\t"
        "}"
        : "+r"(r.a), "+r"(r.b), "+r"(r.c), "+r"(r.d), "+r"(r.e), "+r"(r.f), "+r"(r.g), "+r"(r.h), "=r"(carry)
        : "r"(x.a), "r"(x.b), "r"(x.c), "r"(x.d), "r"(x.e), "r"(x.f), "r"(x.g), "r"(x.h),
          "r"(y.a), "r"(y.b), "r"(y.c), "r"(y.d), "r"(y.e), "r"(y.f), "r"(y.g), "r"(y.h)
    );
...
// Extended Euclidean algorithm for modular inversion - CRITICAL FOR BATCH INVERSION
__device__ _uint256 eeuclid_256_mod_p(_uint256 input) {
    ...
    while (true) {
        ...
        gt |= ((u.a > v.a) && equal); equal &= (u.a == v.a);
