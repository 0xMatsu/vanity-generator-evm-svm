...
// Note: structures.h is NOT included here - caller must define _uint256 and _uint256c before including this file
...
__device__ static inline _uint256c add_256_with_c(_uint256 x, _uint256 y) {
    _uint256c result;
...
__device__ static inline _uint256 sub_256(_uint256 x, _uint256 y) {
    _uint256 result;
...
__device__ static inline _uint256 sub_256_mod_p(_uint256 x, _uint256 y) {
    _uint256 result;
...
__device__ static inline _uint256 mul_256_mod_p(_uint256 x, _uint256 y) {
...
__device__ static inline _uint256 rshift1_256(_uint256 x) {
    _uint256 result;
    result.a =               (x.a >> 1);
...
__device__ static inline _uint256 rshift1_256c(_uint256c x) {
    _uint256 result;
...
__device__ static inline _uint256 eeuclid_256_mod_p(_uint256 input) {
    _uint256 u = input;
    _uint256 v = P;
